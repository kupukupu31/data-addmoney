                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input value="{{ $editData->name }}" name="name" class="form-control"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input value="{{ $editData->email }}" name="email" class="form-control"
                                            type="text" id="example-text-input">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input value="{{ $editData->username }}" name="username" class="form-control"
                                            type="text" id="example-text-input">
                                    </div>
                                </div>
